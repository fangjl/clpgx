...
<body class="login">
	...
	<div class="content">
		...
		<form class="login-form" action="${ctx}/manager/login" method="post">
			...
			<div class="forget-password">
				<h4>忘记密码 ?</h4>
				<p>
					没错, 点击 <a href="javascript:;"  id="forget-password">这里</a>
					重置你的密码.
				</p>
			</div>
			<div class="create-account">
				<p>
					还没有账号吗 ?&nbsp; 
					<a href="javascript:;" id="register-btn" >创建一个新账号吧</a>
				</p>
			</div>
		</form>
		<!-- END LOGIN FORM -->        
		...
		<form class="register-form" action="${ctx}/sys/register" method="post">
			<h3 >注册账号</h3>
			<p>请在下面表单中输入您的信息:</p>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="input-icon">
					<i class="icon-user"></i>
					<input class="form-control placeholder-no-fix" type="text" autocomplete="off" placeholder="Username" name="loginName"/>
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="controls">
					<div class="input-icon">
						<i class="icon-ok"></i>
						<input class="form-control placeholder-no-fix" type="password" autocomplete="off" placeholder="Re-type Your Password" name="plainPassword"/>
					</div>
				</div>
			</div>
			<div class="form-group">
	...
	<script src="${ctx}/static/assets/scripts/login.js" type="text/javascript"></script> 
	<!-- END PAGE LEVEL SCRIPTS --> 
	<script>

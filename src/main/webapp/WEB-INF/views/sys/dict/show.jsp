...
<!-- BEGIN EXAMPLE TABLE PORTLET-->
               ...
               <div class="portlet box blue">
                  <div class="portlet-title">
                     ...
                     <div class="actions">
                        <div class="btn-group">
                           ...
                           <div id="id="com.dlh.clpgx.modules.sys.entity.Dict_list_dom_id_column_toggler" class="dropdown-menu hold-on-click dropdown-checkboxes pull-right">
                  ...
                  <div class="portlet-body">
                     ...
                     <table class="table table-striped table-bordered table-hover table-full-width" id="com.dlh.clpgx.modules.sys.entity.Dict_list_dom_id">
                        <thead>
                           <tr>
                          	  <th>序号</th> 
...
<!-- new Grid -->
<script type="text/javascript">
$('#com.dlh.clpgx.modules.sys.entity.Dict_list_dom_id').dataTable( {
	"bProcessing": true,
    "bServerSide": true,

		...
		<form class="form-horizontal" action="#">
			<div class="form-body">
				...
				<div class="form-group">
							...
							<label  class="col-md-3 control-label">loginName</label>
							<div class="col-md-4">
								<input name="loginName"   placeholder="Enter text" class="form-control">
							</div>
				...
				<div class="form-group">
							...
							<div class="col-md-4">
								<input name="password"   placeholder="Enter text" class="form-control">
							</div>
							<label  class="col-md-3 control-label">registerDate</label>
							<div class="col-md-4">
								<input name="registerDate"   placeholder="Enter text" class="form-control">
							</div>
							<label  class="col-md-3 control-label">roles</label>
							<div class="col-md-4">
								<input name="roles"   placeholder="Enter text" class="form-control">
							</div>
				</div>	
				<div class="form-group">
							<label  class="col-md-3 control-label">salt</label>
							<div class="col-md-4">
								<input name="salt"   placeholder="Enter text" class="form-control">
							</div>
				...
				<div class="form-group">
							...
							<div class="col-md-4">
								<input name="company"   placeholder="Enter text" class="form-control">
							</div>
				</div>	

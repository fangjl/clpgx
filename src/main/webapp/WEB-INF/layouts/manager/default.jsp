...
<body class="page-header-fixed">
   ...
   <!-- END HEADER -->
 	...
 	<div class="page-container">
      ...
      <!-- BEGIN SIDEBAR1 -->
      <%@ include file="/WEB-INF/layouts/manager/sidebar.jsp"%>
 	  <!-- END SIDEBAR1 -->	
   ...
   <script src="${ctx}/static/assets/plugins/flot/jquery.flot.js"></script>
   <script src="${ctx}/static/assets/plugins/flot/jquery.flot.resize.js"></script>
   <script src="${ctx}/static/assets/plugins/flot/jquery.flot.pie.js"></script>
   <script src="${ctx}/static/assets/plugins/flot/jquery.flot.stack.js"></script>
   <script src="${ctx}/static/assets/plugins/flot/jquery.flot.crosshair.js"></script>

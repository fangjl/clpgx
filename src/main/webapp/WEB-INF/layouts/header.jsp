...
<!-- BEGIN TOP NAVIGATION BAR -->
      <div class="header-inner">
         ...
         <img src="${ctx}/static/img/menu-toggler.png" alt="" />
         </a> 
         ...
         <ul class="nav navbar-nav pull-right">
                  ...
                  <li>
                     <ul class="dropdown-menu-list scroller" style="height: 250px;">
                        <li>  
                           ...
                           <span class="photo"><img src="${ctx}/static/img/avatar2.jpg" alt=""/></span>
                           <span class="subject">
                        ...
                        <li>  
                           <a href="inbox.html?a=view">
                           <span class="photo"><img src="${ctx}/static/img/avatar3.jpg" alt=""/></span>
                           <span class="subject">
                        ...
                        <li>  
                           <a href="inbox.html?a=view">
                           <span class="photo"><img src="${ctx}/static/img/avatar1.jpg" alt=""/></span>
                           <span class="subject">
            ...
            <li class="dropdown user">
               ...
               <span class="username">方金林</span>
               <i class="icon-angle-down"></i>
               </a>
               <ul class="dropdown-menu">
                  <li><a href="extra_profile.html"><i class="icon-user"></i> 个人设置</a>
                  </li>
                  <li><a href="page_calendar.html"><i class="icon-calendar"></i> 我的日志</a>
                  </li>

...
public class CompanyController extends BaseController{
	...
	private final String LIST_ACTION = "redirect:/sys/company";
	private final String BASE_PATH = "/sys/company";
	...
	public String index(ModelMap model,Company vo,
			HttpServletRequest request) {
		//model.addAttribute("pages",companyService.findPageByFieldsAndCriteria(new BaseQuery(request, vo)));
	...
	@ResponseBody
	public ResponseEntity<Map> list(ModelMap model,Company vo,
			HttpServletRequest request){
		Page page =companyService.findPageByFieldsOrCriteria(new DatatablesQuery(request, vo));
	...
	public String update(ModelMap model,@PathVariable java.lang.Long id,@Valid Company company,BindingResult errors,

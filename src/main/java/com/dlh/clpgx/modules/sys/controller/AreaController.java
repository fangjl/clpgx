...
import com.dlh.clpgx.modules.sys.service.AreaService;
...
public class AreaController extends BaseController{
	...
	private final String LIST_ACTION = "redirect:/sys/area";
	private final String BASE_PATH = "/sys/area";
	...
	public void init(ModelMap model) {
		...
		model.addAttribute("fields", Area.class.getDeclaredFields());
	}
	...
	public String index(ModelMap model,Area vo,
			HttpServletRequest request) {
		model.addAttribute("pages",areaService.findPageByFieldsAndCriteria(new BaseQuery(request, vo)));
	...
	@ResponseBody
	public ResponseEntity<Map> list(ModelMap model,Area vo,
			HttpServletRequest request){
		Page page =areaService.findPageByFieldsOrCriteria(new DatatablesQuery(request, vo));
	...
	public String create(ModelMap model,RedirectAttributes redirectAttributes,@Valid Area area,BindingResult errors,HttpServletRequest request,HttpServletResponse response) throws Exception {
		if(errors.hasErrors()) {
			return  BASE_PATH+"/new";
		}
	...
	public String edit(ModelMap model,@PathVariable java.lang.Long id)  {
		Area area = (Area)areaService.findOne(id);
		model.addAttribute("area",area);
	...
	public String update(ModelMap model,@PathVariable java.lang.Long id,@Valid Area area,BindingResult errors,

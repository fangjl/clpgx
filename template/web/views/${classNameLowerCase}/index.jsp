...
<!-- BEGIN EXAMPLE TABLE PORTLET-->
               ...
               <div class="portlet box blue">
                  <div class="portlet-title">
                     ...
                     <div class="actions">
                        <div class="btn-group">
                           ...
                           <div id="${className}_list_dom_id_column_toggler" class="dropdown-menu hold-on-click dropdown-checkboxes pull-right">
                  ...
                  <div class="portlet-body">
                     ...
                     <table class="table table-striped table-bordered table-hover table-full-width" id="${className}_list_dom_id">
                        <thead>
                           <tr>
                          	  <th>序号</th> 
...
$('#${className}_list_dom_id').dataTable( {
	"bProcessing": true,
    "bServerSide": true,
